...
module.exports = function(args){
  ...
  if(args.compress) commands.unshift('compress=yes');
  if(args.archive) commands.unshift('archive=yes');
  if(args.delete) commands.unshift('delete=yes');

  params.unshift(commands.join(' '));

  if(args.verbose) params.unshift('-vv');
